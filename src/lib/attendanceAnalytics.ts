...
type MemberEntryRecord = {
  member_id?: string | null;
  punch_in?: string | null;
  punch_out?: string | null;
};

type BuildAttendanceSeriesOptions = {
  profiles?: AttendancePerson[];
  members?: AttendancePerson[];
  punches?: PunchRecord[];
  memberEntries?: MemberEntryRecord[];
  now?: Date;
  dailyWindow?: number;
...
export function buildAttendanceSeries({
  ...
  function markAttendance(personKey?: string | null, timestamp?: string | null) {
